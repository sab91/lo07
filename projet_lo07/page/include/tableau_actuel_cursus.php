<?php
    ...
    $fichier = fopen("C:/wamp64/www/projet_lo07/csv/R_ACTUEL_BR.csv","r"); 
    //lecture du fichier
    $data = fread($fichier, filesize("C:/wamp64/www/projet_lo07/csv/R_ACTUEL_BR.csv"));
    ...
    //affichage pour vérifier les valeurs des arrays
...
?>
    ...
    <table id="cursus">
        ...
        <tr>
            <td>Stage</td>
            <td><?php echo $credit_obtenu['R05']; ?>/<?php echo $array_credit_min['R05'] ?></td>
            <td><?php echo $credit_obtenu['R06']; ?>/<?php echo $array_credit_min['R06'] ?></td>
            <td></td>
            <td><?php echo $credit_obtenu['R06'] + $credit_obtenu['R05']; ?>/<?php echo $array_credit_min['R06'] + $array_credit_min['R05']; ?></td>
        </tr>
        <tr>
            <td>EC</td>
            <td colspan="2"><?php echo $credit_obtenu['R07']; ?>/<?php echo $array_credit_min['R07'] ?></td>
            <td></td>
            <td><?php echo $credit_obtenu['R07']; ?>/<?php echo $array_credit_min['R07'] ?></td>
        </tr>
        <tr>
            <td>ME</td>
            <td colspan="2" rowspan="2"><?php echo $credit_obtenu['R10']; ?>/<?php echo $array_credit_min['R10'] ?></td>
            <td><?php echo $credit_obtenu['R08']; ?>/<?php echo $array_credit_min['R08'] ?></td>
            <td rowspan="2"><?php echo $credit_obtenu['R10']; ?>/<?php echo $array_credit_min['R10'] ?></td>
        ...
        <tr>
            <td>Total</td>
            <td colspan="3"></td>
            <td><?php echo $credit_obtenu['R14']; ?>/<?php echo $array_credit_min['R14'] ?></td>
        </tr>
        <tr>
            <td>NPML</td>
        ...
        <tr>
            ...
            <td colspan="4"><?php if($credit_obtenu['R12'] == 1){echo 'Validé <i class="fa fa-check" style="font-size:30px;color:green"></i>';} else {echo 'Non Validé <i class="fa fa-close" style="font-size:30px;color:red"></i>';} ?></td>
        </tr>
    </table>
    ...
    <div>
        ...
        <ul>
            ...
            foreach($credit_obtenu as $key => $element) {
                validation($element, $array_credit_min[$key], 'CS', 'TCBR');
            }
            ?>
        </ul>
